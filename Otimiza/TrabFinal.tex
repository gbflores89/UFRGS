...
simulações nas etapas de projeto e otimização de processos de separação, como
por exemplo a destilação, são necessários dados de equilíbrio confiáveis e um
modelo de coeficiente de atividade (modelo de $\gamma$ ou também conhecido como
modelo de $g^{\rm{E}}$) robusto o suficiente para o sistema em questão.
...
como diversos modelos de $\gamma$ e modelos de outras propriedades
