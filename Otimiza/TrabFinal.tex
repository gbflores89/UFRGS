...
da função objetivo foi o algoritmo PSO utilizando a combinação de $x$
partículas e $x$ iterações, apresentando valor $xxxx$ na $FO$. Apesar de ser
